...
def get_cmd(task, sub_task, model_tag, gpu, data_num, bs, lr, source_length, target_length, patience, epoch, warmup,
    ...
    return (
        'bash exp_with_args.sh %s %s %s %d %d %d %d %d %d %d %d %d %s %s %s'
        % (
            task,
            sub_task,
            model_tag,
        ...
        else 'bash exp_with_args.sh %s %s %s %d %d %d %d %d %d %d %d %d %s %s %s %d %d %d'
        % (
            task,
            sub_task,
            model_tag,
...
def run_one_exp(args):
    ...
    cmd_str = get_cmd(
        ...
        res_fn=f'{args.res_dir}/{args.task}_{args.model_tag}.txt',
    )
    print('%s\n' % cmd_str)
    os.system(cmd_str)
...
def run_multi_task_exp(args):
    ...
    cmd_str = get_cmd(
        ...
        model_dir=args.model_dir,
        summary_dir=args.summary_dir,
        res_fn=f'{args.res_dir}/multi_task_{args.model_tag}.txt',
        max_steps=max_steps,
